...
export default {
    // Cấu hình chung
    tmnCode: process.env.VNPAY_TMN_CODE || 'YOUR_MERCHANT_CODE',
    hashSecret: process.env.VNPAY_HASH_SECRET || 'YOUR_HASH_SECRET',
    url: process.env.VNPAY_URL || 'https://sandbox.vnpayment.vn/paymentv2/vpcpay.html',
    returnUrl: process.env.VNPAY_RETURN_URL || 'http://localhost:8080/payment/vnpay/return',
    ipnUrl: process.env.VNPAY_IPN_URL || 'http://localhost:8080/payment/vnpay/ipn',
